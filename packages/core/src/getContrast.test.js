// taken from:
// https://github.com/styled-components/polished/blob/0764c982551b487469043acb56281b0358b3107b/src/color/test/getContrast.test.js
...
describe('getContrast', () => {
  ...
  it('should return the color contrast of two 8-digit hex colors', () => {
    expect(getContrast('#6564CDB3', '#ffffff')).toMatchInlineSnapshot(`4.98`);
  });
