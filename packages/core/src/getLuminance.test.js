...
it('should return the luminance of an 8-digit hex color', () => {
  expect(getLuminance('#6564CDB3')).toMatchInlineSnapshot(`0.161`);
});
...
it('should return the luminance of an rgba color', () => {
  expect(getLuminance('rgba(101,100,205,0.7)')).toMatchInlineSnapshot(`0.162`);
});
...
it('should return the luminance of an hlsa color', () => {
  expect(getLuminance('hsla(250, 100%, 50%, 0.2)')).toMatchInlineSnapshot(`0.077`);
});
