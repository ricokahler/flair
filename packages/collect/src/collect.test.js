...
it('collects the static css from a file', () => {
  ...
  expect(css).toMatchInlineSnapshot(`
    ...
    .Example--00000-title{font-size:32px;font-weight:bold;margin:0;flex:0 0 auto;margin-bottom:var(--Example--00000-title-0);color:var(--Example--00000-title-1);border-bottom:1px solid var(--Example--00000-title-2)}@media (max-width:768px){.Example--00000-title{font-size:24px;font-weight:bold;margin:0}}
